                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><a
                                                                        target="_blank" href="https://smartbm3.com"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2CB543;font-size:14px"><img
                                                                            class="adapt-img"
                                                                            src="https://smartbm3.com/storage/logo/logo-dark.png"
                                                                            alt
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        <strong>Konfirmasi Pembayaran</strong></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        Hai {{ $data['name'] }}, link pembayaran
                                                                        berhasil dibuat.<br>Lakukan pembayaran melalui
...
style="height:41px; v-text-anchor:middle; width:190px" arcsize="50%" stroke="f" fillcolor="#405189">
<w:anchorlock></w:anchorlock>
<center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:15px; font-weight:400; line-height:15px; mso-text-raise:1px'>Bayar Sekarang</center>
</v:roundrect></a>
<![endif]-->
                                                                    <!--[if !mso]><!-- --><span
                                                                        class="msohide es-button-border"
                                                                        style="border-style:solid;border-color:#2cb543;background:#405189;border-width:0px;display:inline-block;border-radius:30px;width:auto;mso-hide:all"><a
                                                                            href="{{ $data['link'] }}" class="es-button"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;padding:10px 20px 10px 20px;display:inline-block;background:#405189;border-radius:30px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #405189">Bayar
                                                                            Sekarang</a></span>
                                                                    <!--<![endif]-->
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        <strong>note: </strong>Hati-hati modus
                                                                        penipuan!<br>harap abaikan email&nbsp;ini jika
                                                                        anda tidak merasa melakukan transaksi&nbsp;ini
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
