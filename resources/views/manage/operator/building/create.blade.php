    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('app.building.store') }}" method="post">
                        @csrf
                        ...
                        <div class="row align-items-start mb-5">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="stage" class="form-control @error('stage') is-invalid @enderror" id="stage" value="{{ old('stage') }}">
                                @error('stage')
