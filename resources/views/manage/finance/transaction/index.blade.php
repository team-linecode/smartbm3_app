                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <small class="text-primary">{{ $trans->user->classroom->alias }} {{ $trans->user->expertise->alias }}</small>
                        </td>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <div class="edit">
                                    <a href="{{ route('app.finance.transaction.create_detail', $trans->id) }}" class="btn btn-sm btn-success">Detail</a>
                                </div>
                            </div>
                        </td>
                    </tr>
