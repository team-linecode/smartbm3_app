            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            <a href="{{ route('app.staff.edit', $staff->id) }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('app.staff.save_password', $staff->id) }}" method="post"
                        ...
                        <div class="row align-items-center mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="text-primary fw-bold mb-2">{{ $staff->name }}</div>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-9">
                                <div class="text-primary fw-bold mb-2">{{ $staff->username }}</div>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3">
                            <div class="col-sm-3">
