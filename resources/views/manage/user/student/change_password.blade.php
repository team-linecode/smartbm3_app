            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            <a href="{{ route('app.student.edit', $student->id) }}" class="btn btn-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('app.student.save_password', $student->id) }}" method="post"
                        ...
                        <div class="row align-items-center mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="text-primary fw-bold mb-2">{{ $student->name }}</div>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-9">
                                <div class="text-primary fw-bold mb-2">{{ $student->username }}</div>
                            </div>
                        </div>
                        <div class="row align-items-center mb-3">
                            <div class="col-sm-3">
