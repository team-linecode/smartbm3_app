            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="card-title text-center text-uppercase mb-2 mb-md-0 mb-lg-0">Tambah Siswa PKL</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('app.student_apprenticeship.store') }}" method="post">
                        @csrf
                            ...
                            <div class="col-sm-9">
                                <select class="form-control select2 @error('users') is-invalid @enderror" name="users[]"
                                    ...
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}" {{ select_old_multiple($user->id, old('users')) }}>
