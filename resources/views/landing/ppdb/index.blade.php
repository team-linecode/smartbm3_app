    ...
    <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <img src="{{ Storage::url('logo/logo-dark.png') }}" class="card-logo card-logo-dark" alt="logo dark" height="25">
                <img src="{{ Storage::url('logo/logo-light.png') }}" class="card-logo card-logo-light" alt="logo light" height="25">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#wallet">Masuk</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#marketplace">Daftar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#categories">Cari Temanmu!</a>
                    </li>
                </ul>

                <div class="">
                    <a href="apps-nft-wallet.html" class="btn btn-success"><i class="ri ri-whatsapp-line align-middle"></i> Hubungi Kami</a>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-sm-10">
                    <div class="text-center">
                        <h1 class="display-4 fw-bold lh-base text-white">PPDB SMK BM3</h1>
                        <h4 class="fw-medium mb-4 lh-base text-white">Tahun Pelajaran 2023/2024</h4>
                        {{-- <p class="lead text-white-50 lh-base mb-4 pb-2">Mahir IT, Ya... BM3</p> --}}

                        <div class="hstack gap-2 justify-content-center">
                            <a href="https://smkbm3.sch.id" target="_blank" class="btn btn-primary">Lihat Website Sekolah</a>
                            <a href="apps-nft-explore.html" class="btn btn-danger">Daftar Sekarang <i
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center mb-5">
                        <h2 class="mb-3 fw-semibold lh-base">Daftar Sekarang di <span class="text-primary fw-bold">BM3!</span></h2>
                        <p class="text-muted">Kami membuka pendaftaran tahun ajaran 2023/2024, Ada 2 Gelombang pendaftaran, Daftar segera sebelum terlambat.</p>
                    </div>
                </div><!-- end col -->
            </div><!-- end row -->
                ...
                <div class="col-lg-3">
                    <div class="card text-center border shadow-none">
                        <div class="card-body py-5 px-4">
                            <img src="{{ Storage::url('icon/register.png') }}" alt="" height="150"
                                class="mb-3 pb-2 card-floating-icon">
                            <h4 class="mt-5">Daftar</h4>
                            <p class="text-muted pb-1">LENGKAPI DATA PESERTA DIDIK BARU</p>
                    ...
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                19.29k </p>
                            <h5 class="mb-1"><a href="apps-nft-item-details.html">Creative Filtered Portrait</a>
                            </h5>
                ...
                <div class="col-lg-4 product-item crypto-card 3d-style">
                    <div class="card explore-box card-animate">
                        ...
                        <div class="card-body">
                            <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                14.85k </p>
                            <h5 class="mb-1"><a href="apps-nft-item-details.html">Abstract Face Painting</a>
                            </h5>
