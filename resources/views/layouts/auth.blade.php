...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="/vendor/manage/assets/images/favicon.ico">
...
<body>
    ...
    <!-- particles js -->
    <script src="/vendor/manage/assets/libs/particles.js/particles.js"></script>
    <!-- particles app js -->
    <script src="/vendor/manage/assets/js/pages/particles.app.js"></script>
    <!-- password-addon init -->
    <script src="/vendor/manage/assets/js/pages/password-addon.init.js"></script>
</body>
